...
//validation cellphone
    ...
    errcel.innerHTML='Debe ser un número menor a 10 digitos';
}
...
//Validation country
    if(country.value=='default-option'){
        ...
        alert('Bienvenido '+names.value+' de Colombia');
    }else if(country.value=='ESP'){
        alert('Bienvenido '+names.value+'de España, TIO');
    }else if(country.value=='ARG'){
        alert('Bienvenido '+names.value+' de Argentina CHE!');
    }else if(country.value=='BRA'){
        alert('Bem vindo '+names.value+' do brasil')
    }
